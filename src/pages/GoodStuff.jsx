                ...
                <div className="flex flex-col items-center mx-auto max-w-xl">
                    ...
                    <div className="flex flex-row justify-start items-center mb-2 mx-2">
                        <SocialButton
                            ...
                            size={16}
                        />
                        <Link to={"http://jessetakesashot.blogspot.com"} target="_blank" rel='noopener noreferrer' className="-ml-6 text-dark font-sans tablet:text-xl block">
                            My friend's blog - the life and times of a SoCal pro.
                        </Link>
                    </div>
                    <p className="font-sans mt-4 mb-1 text-center tablet:text-xl">
